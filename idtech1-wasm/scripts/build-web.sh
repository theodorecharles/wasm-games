...
for game in doom heretic hexen; do
    install -m 0644 "${repo_dir}/data/${game}.png" "${repo_dir}/web/assets/${game}.png"
    install -m 0644 "${repo_dir}/data/${game}-192.png" "${repo_dir}/web/assets/${game}-192.png"
    install -m 0644 "${repo_dir}/data/${game}-512.png" "${repo_dir}/web/assets/${game}-512.png"
done
for game in doom heretic hexen; do
